        ...
        <div id="main-cell">
            <div class="cell" onclick="redirect('/panel/jobs')">
                ...
                <div id="jobs-data">
                    ...
                    <p class="status">
                        <span class="material-symbols-outlined ok-icon">check_circle</span>Zakończone: <?= $jobs["ok"]; ?>
                    </p>
                    <p class="status">
                        <span class="material-symbols-outlined pending-icon">apps</span>Wykonane: <?= $jobs["done"]; ?>
                    </p>
                    <p class="status">
                        <span class="material-symbols-outlined payment-icon">error</span>Do opłacenia: <?= $jobs["payment"]; ?>
                    </p>
                    <p class="pending-jobs status">
                        <span class="material-symbols-outlined pending-icon">pending</span>W trakcie: <?= $jobs["pending"]; ?>
                    </p>
                </div>
            </div>
        </div>
